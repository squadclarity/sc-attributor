...
function inferFieldFromElement(el) {
  ...
  // -------------------------------------------------------
  // FORM SUBMIT LISTENER (SHADOW SUBMISSIONS)
  // -------------------------------------------------------
  document.addEventListener(
    ...
    (e) => {
      ...
      // Capture longest text input as "message"
      let message = null;
      let maxLen = 0;
