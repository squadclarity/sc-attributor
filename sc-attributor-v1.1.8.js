// ========== SquadClarity Attributor (SC) v1.1.8 ==========
...
(function () {
  ...
  const SC_COOKIE_INFO = [
    ...
    },
    {
      ...
      category: "Analytics",
      duration: "90 days",
      purpose: "Distinguishes repeat visitors so SquadClarity can connect journeys across visits."
    },
    {
      name: "_sc_sid",
      category: "Analytics",
    ...
    },
    {
      ...
      duration: "30 minutes+",
      purpose: "Helps SquadClarity determine whether a visit is part of the same session."
    }
  ];
  ...
  function openConsentModal() {
    ...
    overlay.innerHTML = `
      <div class="sc-consent-modal" role="dialog" aria-modal="true" aria-labelledby="sc-consent-modal-title">
        <div class="sc-consent-badge">SquadClarity Tracking</div>
        <h2 id="sc-consent-modal-title">Control analytics and attribution cookies</h2>
        <p>We use SquadClarity to understand how visitors reach this site, which pages they view, and whether they submit a form or call. These cookies help with attribution and reporting, and they are only enabled if you choose to allow them.</p>
        <div class="sc-consent-cookie-box">
          <h3 style="margin:0 0 8px;font-size:14px;">What cookies are used?</h3>
          <p style="margin:0 0 6px;">Necessary preferences are stored so we remember your choice. If you accept analytics, SquadClarity will also store visitor and session identifiers for attribution reporting.</p>
          ${buildCookieCardsHtml()}
        </div>
        <p style="margin-top:16px;">Choose whether SquadClarity may set analytics and attribution cookies on this site.</p>
    ...
    overlay.addEventListener("click", (e) => {
      if (e.target === overlay) overlay.classList.add("sc-consent-hidden");
    });
    overlay.querySelector("#sc-modal-close").addEventListener("click", () => overlay.classList.add("sc-consent-hidden"));
